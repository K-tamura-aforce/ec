			...
			<div class="container">
				<div id="item" class="wrapper">
					<div class="item-image">
						<img src="../img/P220620171830.png" alt="">
					</div>

					<div class="item-info">
						<h1 class="item-title">本わらび餅</h1>
						<p>
							もっちりとした食感と風味が懐かしい味わい。<br> ふくよかでいて懐かしい味わいともっちりした食感に仕上げました。<br>
							本蕨餅はきなこと黒蜜をかけてどうぞご賞味ください。<br> <br> ■内容：100g<br>
							■日持ち：90日<br> ■特定原材料：大豆
						</p>
						...
						<a class="cart-btn"
							href="../jp.co.aforce.action/Cart_addAction?product_id=P220620171830">カートに追加</a>
					</div>
				</div>
				<div class="home-link">
