			...
			<div class="member">
				...
				<div class="mv">
					<div class="mv-container">
						...
						<form action="../Product_updateAction" method="post">
							...
							<table class="member-table">
								...
								<tr>
									...
									<td class="member-body"><input type="text"
										name="product_name" class="form-text" maxlength="32"
										value="${sessionScope.product_info.product_name}" required>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="member-body"><input type="text"
										name="product_price" class="form-text" pattern="^[0-9]+$"
										value="${sessionScope.product_info.product_price}" required>円
									</td>
								</tr>
							</table>
					...
					<div class="home-link">
						<a href="product_update_search.jsp">戻る</a>
					</div>
				</div>
			</div>
