...
<body>
	...
	<div class="wrapper">
		...
		<main class="content">
					...
					<div class="mv-container">
						...
						<table class="member-table">
							<tr>
								...
								<td class="member-body">${sessionScope.purchase_info.purchase_name}</td>
							</tr>
							<tr>
								<th class="member-item">郵便番号</th>
								<td class="member-body">${sessionScope.purchase_info.purchase_post_code}</td>
							</tr>
							<tr>
								<th class="member-item">住所</th>
								<td class="member-body">${sessionScope.purchase_info.purchase_address}</td>
							</tr>
							<tr>
								<th class="member-item">支払方法</th>
								<td class="member-body"><c:if
										test="${sessionScope.purchase_info.payment_method == 100 }">クレジットカード払い</c:if>
									<c:if
										test="${sessionScope.purchase_info.payment_method == 200 }">コンビニ払い</c:if>
									<c:if
										test="${sessionScope.purchase_info.payment_method == 300 }">代引き払い</c:if>
								</td>
							</tr>
			...
			<div class="home-link">
				<a href="../views/purchase.jsp">戻る</a>
			</div>
