...
@WebServlet(urlPatterns = { "/Product_delete_displayAction" })
public class Product_delete_displayAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path = "/ShoppingSite/views/product_delete_search.jsp";
		...
		try {
			...
			if (product_info == null) {
				...
				response.sendRedirect("/ShoppingSite/views/product_delete.jsp");
			}
